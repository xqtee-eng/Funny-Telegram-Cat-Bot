...
MEME_TEMPLATES = (
    ...
    "Комісія з мемів постановила: {text} зараховано.",
    "Якщо коротко: {text}. Якщо довго: краще не треба.",
    "Коли відкрив Telegram на секунду, а там уже {text}.",
    "Стабільність? Ні, сьогодні у нас {text}.",
    "Це не кринж, це {text} у преміум-версії.",
)
...
ROAST_TEMPLATES = (
    ...
    "{text} має вайб файлу final_final_REAL_last.py.",
    "{text} не просило уваги, але забрало всю кімнату.",
    "{text} виглядає так, ніби його придумав сонний калькулятор.",
    "{text} настільки сміливе, що логіка вийшла з чату.",
    "{text} - це коли фантазія перемогла здоровий глузд.",
)
